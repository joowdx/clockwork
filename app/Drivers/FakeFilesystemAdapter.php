...
class FakeFilesystemAdapter implements FilesystemAdapter
{
    ...
    public function mimeType(string $path): FileAttributes
    {
        ...
        return new FileAttributes($path, mimeType: Storage::mimeType($matches ? explode(',', $path)[1] : $path));
    }
    ...
    public function fileSize(string $path): FileAttributes
    {
        ...
        return new FileAttributes($path, fileSize: $matches ? strlen(base64_decode(explode(',', $path)[1])) : strlen($path));
    }
