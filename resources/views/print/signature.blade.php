<div style="position: relative">
    ...
    @if ($signed ?? false)
        <div style="position:absolute;top:-10pt;font-weight:normal;">
            <div style="display:flex;align-items:center;justify-content:center;">
                <div style="color:#4BB54399;display:flex;align-items:center;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" style="width:auto;height:12pt;">
                ...
                <div style="display:flex;flex-direction:column;text-align:left;font-size:4pt;font-family:Cousine;">
