                                        ...
                                        @else
                                            @for ($k = 0; $k < 2; $k++)
                                                ...
                                                @elseif ($j + $i * 30 < $count)
                                                    ...
                                                    <td height="20">
                                                        <div class="font-sm nowrap consolas bold {{ $employee->timelogs->filter(fn ($time) => $time->time->isSameDay($date))->sortBy('time')->first()?->scanner->name }}">
                                                            {{ $employee->timelogs->filter(fn ($time) => $time->time->isSameDay($date))->sortBy('time')->pluck('time')->first()?->format('H:i') }}
                                                        </div>
                                                    </td>
